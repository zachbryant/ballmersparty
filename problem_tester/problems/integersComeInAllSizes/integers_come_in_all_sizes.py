...
class IntegersComeInAllSizes(TestInputFormat):
    """
...
input_format = IntegersComeInAllSizes()

# input: #of test, input format, solution, name
test_generator = TestGenerator(10, input_format, Language.python('logic'), "IntegersComeInAllSizes")
test_generator.run()
